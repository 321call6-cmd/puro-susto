...
const TEXTOS = {
  es: {
    ...
    'rsvp.caption': 'Disfraz obligatorio · acompañantes pagan cuota completa · el pago se coordina por WhatsApp',
    ...
    'rsvp.acomp': '¿Cuántos acompañantes traes?',
    'rsvp.acomp.0': 'Voy solo/a',
    'rsvp.acomp.1': '+1 acompañante',
    'rsvp.acomp.n': '+{n} acompañantes',
    'rsvp.acompNombre': 'Nombre del acompañante {n}',
    'rsvp.acompNombre.ph': 'Nombre y apellido',
    'rsvp.sindisfraz': '¿Alguien de tu grupo irá sin disfraz? (+$200 MXN c/u, directo al premio)',
    'rsvp.sindisfraz.0': 'Nadie — todos disfrazados 🎃',
    'rsvp.sindisfraz.n': '{n} sin disfraz (+{monto})',
    ...
    'conf.personas': 'personas confirmadas',
    ...
    'conf.invitadoDe': 'Invitado de {nombre}',
    'conf.invitadoPor': 'Invitado por {nombre}',
    ...
    'cuota.explica': 'Los gastos <b>fijos</b> se dividen entre todos los confirmados; los <b>por persona</b> se suman por cabeza. Entre más seamos, más barato sale el susto.',
  ...
  en: {
    ...
    'rsvp.caption': 'Costume required · guests pay full share · payment is arranged over WhatsApp',
    ...
    'rsvp.acomp': 'How many guests are you bringing?',
    'rsvp.acomp.0': 'Just me',
    'rsvp.acomp.1': '+1 guest',
    'rsvp.acomp.n': '+{n} guests',
    'rsvp.acompNombre': 'Guest {n} name',
    'rsvp.acompNombre.ph': 'First and last name',
    'rsvp.sindisfraz': 'Anyone in your group showing up without a costume? (+$200 MXN each, straight to the prize)',
    'rsvp.sindisfraz.0': 'Nobody — all in costume 🎃',
    'rsvp.sindisfraz.n': '{n} without a costume (+{monto})',
    ...
    'conf.personas': 'people confirmed',
    ...
    'conf.invitadoDe': "{nombre}'s guest",
    'conf.invitadoPor': 'Invited by {nombre}',
    ...
    'cuota.explica': '<b>Fixed</b> costs are split among everyone who confirms; <b>per person</b> costs are charged per head. The more of us there are, the cheaper the scare.',
...
function aplicarIdioma() {
  ...
  // Opciones 2..4 de acompañantes: llevan plural, se arman con la plantilla.
  const selAcomp = document.getElementById('f-acomp');
  if (selAcomp) {
    Array.prototype.forEach.call(selAcomp.options, (op) => {
      const n = Number(op.value);
      if (n >= 2) op.textContent = t('rsvp.acomp.n', { n });
    });
  }
