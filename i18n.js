...
const TEXTOS = {
  es: {
    ...
    'noche.r3': '<b>Cada quien se registra por su cuenta</b> — y los peques entran gratis, no pagan cuota ni cuentan para dividir.',
    ...
    'faq.a1': 'La cuota es transparente y en vivo: gastos fijos divididos entre los que pagan + gastos por persona. Los peques no cuentan para dividir. El número exacto está en <a href="index.html#cuota">Cuota</a> y baja conforme más gente confirma.',
    'faq.q2': '¿Puedo llevar a alguien?',
    'faq.a2': 'Claro, pero <b>cada quien se registra por su cuenta</b>: pásale el link y que se apunte. Así nadie se cuenta doble y las cuentas salen parejas. <b>Los niños chiquitos no pagan</b> — a esos sí los apuntas tú desde tu propio registro.',
  ...
  en: {
    ...
    'gancho.sub': 'And the prize <b>grows with every new victim</b>. The more of us, the bigger it gets — all you have to do is show up in costume.',
    ...
    'gancho.logrado': "We're past the goal — and the prize keeps climbing with every new victim.",
    'gancho.vacio': 'Nobody yet. The first one in kicks off the prize — and takes top billing on the list.',
    'gancho.cta': 'Sign up and get that costume ready 😈',
    ...
    'rsvp.soloTu': 'This form signs <b>you</b> up. If you\'re coming with someone, have them open the site and sign up themselves — that way nobody gets counted twice and the math stays honest.',
    ...
    'conf.todosDisfrazados': "Nobody's chickened out of a costume yet 🎃",
    'conf.numero': '#{n}',
    ...
    'noche.r3': '<b>Everyone signs up for themselves</b> — and little kids get in free: no share, and they don\'t count toward the split.',
    ...
    'faq.a1': 'The share is transparent and live: fixed costs split among everyone who pays, plus per-person costs. Little kids don\'t count toward the split. The exact number is under <a href="index.html#cuota">Cost</a>, and it drops as more people confirm.',
    'faq.q2': 'Can I bring someone?',
    'faq.a2': 'Sure, but <b>everyone signs up for themselves</b>: send them the link and let them add themselves. That way nobody gets counted twice and the math stays honest. <b>Little kids don\'t pay</b> — those you add from your own sign-up.',
